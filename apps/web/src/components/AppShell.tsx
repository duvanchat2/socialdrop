...
import {
  ...
  ListOrdered, GitBranch, Inbox, Zap, Terminal, Youtube, Brain, LogOut,
} from 'lucide-react';
      ...
      >
        ...
        <div className="p-3 border-t border-gray-200 dark:border-gray-800 space-y-2">
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-gray-500 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors"
          >
            <LogOut size={15} />
            Cerrar sesión
          </button>
          <p className="px-3 text-xs text-gray-400 dark:text-gray-600">v1.0.0</p>
        </div>
      </aside>
    </>
  );
